...
syn match       goBlockContainer    "[{}]"

syn keyword     goDirective         package import
syn keyword     goDeclaration       var const type
syn keyword     goDeclType          struct interface

hi def link     goBlockContainer    Include
...
syn match       goFunction          "\%(\%(func\|type\)\s*\)\@<=\h\w*"
syn match       goFunction          "\%(func\s*(.*)\s*\)\@<=\h\w*"

syn match       goConst             "[A-Z_][A-Z_]\+\%(\w\)\@!"

hi def link     goConst             Number
